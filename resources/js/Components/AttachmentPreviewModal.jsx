            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="h-screen w-screen">
                        ...
                        >
                            <Dialog.Panel
                                className="flex flex-col w-full h-full transform overflow-hidden bg-slate-800 text-left
                                align-middle shadow-xl transition-all"
                            >
                                <button
                                    onClick={close}
                                    className="absolute right-3 top-3 w-10 h-10 rounded-full hover:bg-black/10 transition
                                    flex items-center justify-center text-blue-100 z-40 bg-black-500"
                                >
                                    <XMarkIcon className="w-6 h-6"/>
                                </button>

                                <div className="relative group h-full bg-white-500">
                                    {currentIndex > 0 && (
                                        <div
                                            onClick={prev}
                                            className="absolute opacity-100 text-black-500 cursor-pointer flex items-center
                                            justify-center w-16 h-16 left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50
                                            z-30"
                                        >
                                    ...
                                    {attachment && (
                                        <div className="flex items-center justify-center w-full h-full p-3">
                                            ...
                                            {!isPreviewable(attachment) && (
                                                <div className="p-32 flex flex-col justify-center items-center text-blue-100">
